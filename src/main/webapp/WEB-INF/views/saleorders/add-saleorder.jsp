  ...
  <main id="main" class="main">
    ...
    <section class="section">
      <div class="row">
          ...
          <div class="card">
            <div class="card-body">
             <h3 class="card-title"><span th:text ="${job.name }"></span></h3>
              <!-- General Form Elements -->
              <form action="/saveSO" method="post">
              <input type="hidden" name="job_id" th:value="${job.id }" />
                <div class="row mb-3">
                  <label for="item_name" class="col-sm-2 col-form-label">SO Name</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name ="name">
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="item_size" class="col-sm-2 col-form-label">Total Amount</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name ="totalAmt">
                  </div>
                </div>

                <div class="row mb-3">
                  <div class="col-sm-10">
                    <button type="submit" class="btn btn-primary">Save SO</button>
                  </div>
                </div>
