            ...
            <div class="card-body">
              ...
              <form action="/updateProduct" method="post">
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name ="itemName" th:value="${product.itemName}">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name ="itemSize" th:value="${product.itemSize}">
                  </div>
                </div>
<!--                 <div class="row mb-3">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="date" class="form-control" name ="scheduleDate" th:field="*{product.scheduleDate}">
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="inputTime" class="col-sm-2 col-form-label">Time</label>
                  <div class="col-sm-10">
                    <input type="time" class="form-control" name ="scheduleTime" th:field="*{product.scheduleTime}">
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="color" class="form-control form-control-color" name="color" th:value="${product.color}" title="Choose your color">
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="inputPassword" class="col-sm-2 col-form-label">Description</label>
                  <div class="col-sm-10">
                    <textarea class="form-control" style="height: 100px" name ="description" th:text="${product.description}"></textarea>
                  </div>
                </div>
              <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <div class="form-check">
                      <input class="form-check-input" type="checkbox" name="active" id ="active"  th:checked="${product.active}">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <div class="form-check">
                      <input class="form-check-input" type="checkbox" name="specialItem" id ="specialItem"  th:checked="${product.specialItem}">
                      <label class="form-check-label" for="specialItem">
                      </label>
                    </div>
                  ...
                  <div class="col-sm-10">
                    <select class="form-select" aria-label="Default select example" name ="materialType">
                     <option th:each="material : ${materiallist}"
		                    th:text="${material}"
		                    th:value="${material}"
		                    th:selected="${material==product.materialType}">
                    </select>
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <select class="form-select" multiple aria-label="multiple select example" name ="multiSelect">
                        <option th:each="material : ${multiselect}"
		                    th:text="${material}"
		                    th:value="${material}"
		                     th:selected="${product.multiSelect?.contains(material)}"
		                    >
                    </select>
                  </div>
                </div>
