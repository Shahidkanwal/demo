  ...
  <main id="main" class="main">
    ...
    <section class="section">
      <div class="row">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Fill For Job</h5>

              <!-- General Form Elements -->
              <form action="/updateJob" method="post">
                <div class="row mb-3">
                  <label for="item_name" class="col-sm-2 col-form-label">Job Name</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name ="name" th:value="${job.name}">
                     <input type="hidden" class="form-control" name ="Id" th:value="${job.Id}">
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="item_size" class="col-sm-2 col-form-label">Item Size</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name ="salesperson" th:value="${job.salesperson}">
                  </div>
                </div>
