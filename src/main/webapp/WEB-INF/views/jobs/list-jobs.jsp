            ...
            <div class="card-body">
              ...
              <table class="table table-striped">
                ...
                <tr th:each="job , iterator: ${jobs}">
			        ...
			        <td class="align-middle" th:text="${job.name}"></td>
			        <td class="align-middle" th:text="${job.salesperson}"></td>
			        <td class="align-middle"><a th:href="@{/editJob(job_id=${job.Id})}" class="btn btn-primary">Edit</a>
			        <a th:href="@{/addSaleorder(job_id=${job.Id})}" class="btn btn-primary">Add SO</a>
			        <a th:href="@{/deleteJob(job_id=${job.Id})}" class="btn btn-danger">Delete</a></td>
			    </tr>
