...
<!--                 <div class="row mb-3">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    ...
                    <div class="form-check">
                      <input class="form-check-input" type="checkbox" name="specialItem">
                      <label class="form-check-label" for="special_item">
                      </label>
                    </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <select class="form-select" aria-label="Default select example" name ="materialType">
                       	<option label="Tree – Cont" value="Tree – Cont" selected="selected">Tree – Cont</option>
						<option label="Tree - BB" value="Tree - BB">Tree - BB</option>
						<option label="Ornamental Lg" value="Ornamental Lg">Ornamental Lg</option>
						<option label="Ornamental Sm" value="Ornamental Sm">Ornamental Sm</option>
						<option label="Shrub" value="Shrub">Shrub</option>
						<option label="Groundcover" value="Groundcover">Groundcover</option>
						<option label="Soil/Mulch" value="Soil/Mulch">Soil/Mulch</option>
						<option label="Sod" value="Sod">Sod</option>
                    </select>
                  </div>
                </div>
